...
if (past_framesize >= min(positions_history$open_time))
  past_framesize <- 1
...
# Entry analysis.
framesize <- as.integer(quantile(hold_times, 0.75))

post_entry <- apply(positions_history, 1, function(order) {
...
pre_entry <- apply(positions_history, 1, function(o) {
